...
for epoch in range(1, TRAIN_EPOCH+1):
    ...
    if epoch % MODEL_SAVE_INTERVAL == 0:
        ...
        placeholder_path = os.path.join(MODEL_DIR, f'lumos_model_ep_{epoch}_temp.pth')
        ...
        final_path = os.path.join(MODEL_DIR, f'lumos_model_ep_{epoch}_{test_score:.3f}.pth')
